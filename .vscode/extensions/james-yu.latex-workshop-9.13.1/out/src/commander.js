...
exports.toggleMathPreviewPanel = exports.closeMathPreviewPanel = exports.openMathPreviewPanel = exports.saveActive = exports.texdocUsepackages = exports.texdoc = exports.devStripText = exports.devParseBib = exports.devParseTeX = exports.devParseLog = exports.selectSection = exports.shiftSectioningLevel = exports.toggleSelectedKeyword = exports.onEnterKey = exports.insertSnippet = exports.actions = exports.resetHostName = exports.changeHostName = exports.closeEnv = exports.toggleEquationEnv = exports.multiCursorEnvName = exports.selectEnvName = exports.selectEnvContent = exports.navigateToEnvPair = exports.gotoSection = exports.showLog = exports.wordcount = exports.citation = exports.addTexRoot = exports.clean = exports.synctexonref = exports.synctex = exports.kill = exports.refresh = exports.view = exports.recipes = exports.revealOutputDir = exports.build = void 0;
...
function devParseLog() {
    ...
    parser_1.parser.parseLog(vscode.window.activeTextEditor.document.getText());
}
...
async function devParseTeX() {
    ...
    const ast = await parser_1.parser.parseLaTeX(vscode.window.activeTextEditor.document.getText());
...
async function devParseBib() {
    ...
    const ast = await parser_1.parser.parseBibTeX(vscode.window.activeTextEditor.document.getText());
    return vscode.workspace.openTextDocument({ content: JSON.stringify(ast, null, 2), language: 'json' }).then(doc => vscode.window.showTextDocument(doc));
}
