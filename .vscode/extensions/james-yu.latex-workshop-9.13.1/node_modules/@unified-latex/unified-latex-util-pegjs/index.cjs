...
// index.ts
var unified_latex_util_pegjs_exports = {};
__export(unified_latex_util_pegjs_exports, {
  AlignEnvironmentPegParser: () => AlignEnvironmentPegParser,
  ArgSpecPegParser: () => ArgSpecPegParser,
  GluePegParser: () => GluePegParser,
  LatexPegParser: () => LatexPegParser,
  LigaturesPegParser: () => LigaturesPegParser,
  MacroSubstitutionPegParser: () => MacroSubstitutionPegParser,
  PgfkeysPegParser: () => PgfkeysPegParser,
  SystemePegParser: () => SystemePegParser,
  TabularPegParser: () => TabularPegParser,
  TikzPegParser: () => TikzPegParser,
  XColorPegParser: () => XColorPegParser,
  decorateArrayForPegjs: () => decorateArrayForPegjs,
  splitStringsIntoSingleChars: () => splitStringsIntoSingleChars
});
module.exports = __toCommonJS(unified_latex_util_pegjs_exports);
