...
function printRaw2(node, root = false) {
  ...
  const defaultArg = node.defaultArg ? printRaw2(node.defaultArg) : "";
  let spec = decorators;
  ...
  switch (type) {
    ...
    case "embellishment":
      ...
      return spec + "{" + printRaw2(node.embellishmentTokens) + "}" + defaultArg;
    case "verbatim":
      return spec + "v" + node.openBrace;
    case "group":
      return spec + "{" + printRaw2(node.content) + "}";
    case "until": {
      const stopTokens = printRaw2(node.stopTokens);
