...
const unified_defs_1 = require("./parserlib/unified-defs");
...
const pool = workerpool.pool(path.join(__dirname, 'parserlib', 'unified.js'), { minWorkers: 1, maxWorkers: 1, workerType: 'thread' });
