...
exports.Manager = exports.isBinary = exports.isTeX = void 0;
...
const TEX_EXT = ['.tex', '.bib'];
const TEX_NOCACHE_EXT = ['.cls', '.sty', '.bst', '.bbx', '.cbx', '.def', '.cfg'];
const RSWEAVE_EXT = ['.rnw', '.Rnw', '.rtex', '.Rtex', '.snw', '.Snw'];
const JLWEAVE_EXT = ['.jnw', '.jtexw'];
const PWEAVE_EXT = ['.pnw', '.ptexw'];
function isTeX(extname) {
    return [...TEX_EXT, ...RSWEAVE_EXT, ...JLWEAVE_EXT, ...PWEAVE_EXT].includes(extname);
}
exports.isTeX = isTeX;
function isBinary(extname) {
