...
class DocSymbolProvider {
    ...
    sectionToKind(section) {
        if (section.type === structure_1.TeXElementType.Section || section.type === structure_1.TeXElementType.SectionAst) {
            return vscode.SymbolKind.Struct;
        }
        if (section.type === structure_1.TeXElementType.Environment) {
            return vscode.SymbolKind.Package;
        }
        if (section.type === structure_1.TeXElementType.Command) {
            return vscode.SymbolKind.Number;
        }
        if (section.type === structure_1.TeXElementType.SubFile) {
            return vscode.SymbolKind.File;
        }
        if (section.type === structure_1.TeXElementType.BibItem) {
            return vscode.SymbolKind.Class;
        }
        if (section.type === structure_1.TeXElementType.BibField) {
